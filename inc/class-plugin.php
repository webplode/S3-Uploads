...
class Plugin {
	...
	public function generate_htaccess_rules() {
		...
		$htaccess_content .= "# Redirect image files (jpg, jpeg, png) from wp-content/uploads to CDN with .webp extension\n";
		$htaccess_content .= "RewriteRule ^wp-content/uploads/(.*)\\.jpg$ {$cdn_url}/uploads/\$1.jpg.webp [R=301,L]\n";
		$htaccess_content .= "RewriteRule ^wp-content/uploads/(.*)\\.jpeg$ {$cdn_url}/uploads/\$1.jpeg.webp [R=301,L]\n";
		$htaccess_content .= "RewriteRule ^wp-content/uploads/(.*)\\.png$ {$cdn_url}/uploads/\$1.png.webp [R=301,L]\n\n";
		...
		$htaccess_content .= "# Redirect wp-content/uploads path to /uploads\n";
		$htaccess_content .= "RewriteRule ^wp-content/uploads/(.*)$ /uploads/\$1 [R=301,L]\n";
